...
async function getContainerRuntimeClient() {
    ...
    for (const strategy of strategies) {
        try {
            common_1.log.debug(`Testing container runtime strategy "${strategy.getName()}"...`);
            ...
            common_1.log.debug(`Container runtime strategy "${strategy.getName()}" does not work`);
        }
    }
...
async function initStrategy(strategy) {
    ...
    const dockerode = new dockerode_1.default(result.dockerOptions);
    ...
    const containerRuntimeInfo = {
        host,
        hostIps: await (0, lookup_host_ips_1.lookupHostIps)(host),
